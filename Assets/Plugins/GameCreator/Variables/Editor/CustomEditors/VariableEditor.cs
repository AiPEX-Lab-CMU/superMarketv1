namespace GameCreator.Variables
{
    ...
    public abstract class VariableEditor : Editor
    {
        ...
        private static readonly Regex REGEX_VARNAME = new Regex(@"[^a-zA-Z0-9-]");
        private static readonly Regex REGEX_VARPATH = new Regex(@"[^a-zA-Z0-9-\/]");
        ...
        public static string ProcessName(string name, bool isPath = false)
        {
            ...
            switch (isPath)
            {
                case true:  return REGEX_VARPATH.Replace(name, "-");
                case false: return REGEX_VARNAME.Replace(name, "-");
            }
